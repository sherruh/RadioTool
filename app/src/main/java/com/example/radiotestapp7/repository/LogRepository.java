...
import com.example.radiotestapp7.repository.local.ILocalLogRepository;
import com.example.radiotestapp7.repository.local.LogFileWriter;
import com.example.radiotestapp7.utils.Logger;
import com.example.radiotestapp7.utils.SingleLiveEvent;
...
public class LogRepository {
    ...
    public void setUlThrputStartTime(long ulThrputStartTime) {
        synchronized (this) {
            Logger.d("TestResultData ulThrputStartTime " + ulThrputStartTime);
            mLog.setUlThrputStartTime(ulThrputStartTime);
        }
    }

    public void setUlThrputStartBytes(long ulThrputBytes) {
        synchronized (this) {
            Logger.d("TestResultData ulThrputBytes " + ulThrputBytes);
            mLog.setUlThrputStartBytes(ulThrputBytes);
        }
    }

    public void setUlThrputFinishTime(long ulThrputFinishTime) {
        synchronized (this) {
            Logger.d("TestResultData ulThrputFinishTime " + ulThrputFinishTime);
            mLog.setUlThrputFinishTime(ulThrputFinishTime);
        }
    }

    public void setUlThrputFinishBytes(long ulThrputFinishBytes) {
        synchronized (this) {
            Logger.d("TestResultData ulThrputFinishBytes " + ulThrputFinishBytes);
            mLog.setUlThrputFinishBytes(ulThrputFinishBytes);
        }
    }

    public void setDlThrputStartBytes(long dlThrputStartBytes) {
        synchronized (this) {
            Logger.d("TestResultData dlThrputBytes " + dlThrputStartBytes);
            mLog.setDlThrputStartBytes(dlThrputStartBytes);
        }
    }

    public void setDlThrputStartTime(long dlThrputStartTime) {
        synchronized (this) {
            Logger.d("TestResultData dlThrputStartTime " + dlThrputStartTime);
            mLog.setDlThrputStartTime(dlThrputStartTime);
        }
    }

    public void setDlThrputFinishBytes(long dlThrputFinishBytes) {
        synchronized (this) {
            Logger.d("TestResultData dlThrputFinishBytes " + dlThrputFinishBytes);
            mLog.setDlThrputFinishBytes(dlThrputFinishBytes);
        }
    }

    public void setDlThrputFinishTime(long dlThrputFinishTime) {
        synchronized (this) {
            Logger.d("TestResultData dlThrputFinishTime " + dlThrputFinishTime);
            mLog.setDlThrputFinishTime(dlThrputFinishTime);
        }
    }
