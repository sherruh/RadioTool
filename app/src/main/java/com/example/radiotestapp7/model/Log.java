package com.example.radiotestapp7.model;

import androidx.room.Entity;
import androidx.room.PrimaryKey;

import com.example.radiotestapp7.enums.EEvents;
import com.example.radiotestapp7.enums.EState;
import com.example.radiotestapp7.enums.EYoutubeState;
import com.example.radiotestapp7.utils.DateConverter;
...
public class Log implements Cloneable {
    ...
    private long dlThrputStartTime;
    private long dlThrputFinishTime;
    private long ulThrputStartTime;
    private long ulThrputFinishTime;
    private long dlThrputFinishBytes;
    private long ulThrputStartBytes;
    private long ulThrputFinishBytes;
    private long dlThrputStartBytes;

    public Log(long id, String logId, long date, double longitude, double latitude, int altitude, String mcc, String mnc, String technology, String tacLac, String eNodeB, String cellId, String bsic, String psc, String pci, String rsrp, String rsrq, String rscp, String rxLevel, String cqi, String snr, String ecNO, String ber, String channel, long dlThrput, long ulThrput, int ping, String youtubeResolution, EEvents eEvent, String eventParam, String eventDescription, EState logState, EYoutubeState youtubeState, long dlThrputStartTime, long dlThrputFinishTime, long ulThrputStartTime, long ulThrputFinishTime, long dlThrputFinishBytes, long ulThrputStartBytes, long ulThrputFinishBytes, long dlThrputStartBytes) {
        this.id = id;
        this.logId = logId;
        this.date = date;
        ...
        this.dlThrputStartTime = dlThrputStartTime;
        this.dlThrputFinishTime = dlThrputFinishTime;
        this.ulThrputStartTime = ulThrputStartTime;
        this.ulThrputFinishTime = ulThrputFinishTime;
        this.dlThrputFinishBytes = dlThrputFinishBytes;
        this.ulThrputStartBytes = ulThrputStartBytes;
        this.ulThrputFinishBytes = ulThrputFinishBytes;
        this.dlThrputStartBytes = dlThrputStartBytes;
    }

    public long getDlThrputFinishBytes() {
        return dlThrputFinishBytes;
    }

    public void setDlThrputFinishBytes(long dlThrputFinishBytes) {
        this.dlThrputFinishBytes = dlThrputFinishBytes;
    }

    public long getUlThrputStartBytes() {
        return ulThrputStartBytes;
    }

    public void setUlThrputStartBytes(long ulThrputStartBytes) {
        this.ulThrputStartBytes = ulThrputStartBytes;
    }

    public long getUlThrputFinishBytes() {
        return ulThrputFinishBytes;
    }

    public void setUlThrputFinishBytes(long ulThrputFinishBytes) {
        this.ulThrputFinishBytes = ulThrputFinishBytes;
    }

    public long getDlThrputStartBytes() {
        return dlThrputStartBytes;
    }

    public void setDlThrputStartBytes(long dlThrputStartBytes) {
        this.dlThrputStartBytes = dlThrputStartBytes;
    }

    public long getDlThrputStartTime() {
        return dlThrputStartTime;
    }

    public void setDlThrputStartTime(long dlThrputStartTime) {
        this.dlThrputStartTime = dlThrputStartTime;
    }

    public long getDlThrputFinishTime() {
        return dlThrputFinishTime;
    }

    public void setDlThrputFinishTime(long dlThrputFinishTime) {
        this.dlThrputFinishTime = dlThrputFinishTime;
    }

    public long getUlThrputStartTime() {
        return ulThrputStartTime;
    }

    public void setUlThrputStartTime(long ulThrputStartTime) {
        this.ulThrputStartTime = ulThrputStartTime;
    }

    public long getUlThrputFinishTime() {
        return ulThrputFinishTime;
    }

    public void setUlThrputFinishTime(long ulThrputFinishTime) {
        this.ulThrputFinishTime = ulThrputFinishTime;
    }
